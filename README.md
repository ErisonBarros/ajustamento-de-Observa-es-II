...
* **/material\_de\_aula**: Slides, notas de aula e leituras recomendadas.
* **/exercicios**: Listas de exercícios e atividades práticas.
* **/exemplos\_de\_codigo**: Exemplos em Python e outros softwares.
...
@software{Aulas de Ajustamento de Observações II\_2024, author = {Lisa, Mona and Bot, Hew}, doi = {}, month = {12}, title = \{{Aulas de Ajustamento de Observações II\}}, url = {https://https://github.com/ErisonBarros/ajustamento-de-Observa-es-II}, version = {1.0.0}, year = {2024} } Erison Rosa de Oliveira Barros erison.barros@ufpe.br https://github.com/ErisonBarros/ErisonBarros
